...
### GrowthBook Flag 오버라이드 -- 제어된 제거 테스트 (4월 10-15일)
...
| **4월 10일 14:25 -- 4월 15일** | **9,996** | **0** | **0** | 오버라이드 활성 |

마지막 B5 이벤트: **2026년 4월 10일 14:25:04 KST**. 마지막 B4 이벤트: **2026년 4월 10일 19:55:47 KST**. 이 시점 이후 5일간 9,996건의 요청에서 이벤트 0건 -- 동일한 머신, 동일한 계정, 동일한 사용 패턴. 변경된 유일한 변수는 GrowthBook flag 값이었습니다.
