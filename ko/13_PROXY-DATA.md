...
*환경: Max 20x ($200/월), Opus 4.6 1M, v2.1.91, Linux (ubuntu-1), 단일 머신. cc-relay 프록시: 17,610건 요청 (4월 1-8일), SQLite 22.5 MB. JSONL 코퍼스: 1,735개 이상 파일 (최근 7일 532개), 158.3 MB. 데이터 수집 진행 중 — 사용이 계속되면 수치는 증가합니다.*
